...
function PureSuggestedActions({ chatId, sendMessage }: SuggestedActionsProps) {
  ...
  const suggestedActions = [
    "What's hostel life like at IIT Bombay?",
    'Tell me about placements and packages for CS students',
    'Which campus fests are the most popular?',
    "How's the food in mess? Best canteens?",
  ];
